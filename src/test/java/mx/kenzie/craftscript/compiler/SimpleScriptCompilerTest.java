...
public class SimpleScriptCompilerTest {
    ...
    private static final File folder = new File("target/test-scripts/");
    ...
    private AbstractScript parse(String name, String content) {
        return manager.parseScript(name + ".script", content);
    }

    private boolean test(String source) {
    ...
    private boolean compile(AbstractScript script) throws Throwable {
